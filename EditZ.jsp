			...
			<div class="table"
				...
				<div id="table" class="table-editable">
					<table class="table" border="1" id="tableMain">
						...
						<s:iterator value="listManz_z10fEdit" var="i">
							<tr> 
								<td contenteditable="true"><input class="form-control" maxlength="254" type="text" name="text" value="${i.品目c}"></td>
								<td contenteditable="true"><input class="form-control" maxlength="254" type="text" name="text" value="${i.品目名}"></td>
								<td contenteditable="true"><input class="form-control" maxlength="254" type="text" name="text" value="${i.品番}"></td>
								<td contenteditable="true"><input class="form-control" maxlength="254" type="text" name="text" value="${i.新在庫数量}"></td>
								<td contenteditable="true"><input class="form-control" maxlength="254" type="text" name="text" value="${i.在庫日}"></td>
								<td contenteditable="true"><input class="form-control" maxlength="254" type="text" name="text" value="${i.得意先名}"></td>
								<td contenteditable="true"><input class="form-control" maxlength="254" type="text" name="text" value="${i.メーカーロット}"></td>
								<td contenteditable="true"><input class="form-control" maxlength="254" type="text" name="text" value="${i.品名}"></td>
							</tr>
						</s:iterator>
